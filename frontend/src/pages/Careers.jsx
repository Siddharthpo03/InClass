...
const Careers = () => {
  ...
  return (
    <PageLayout
      ...
      heroTitle="Build the Future of Education"
      heroSubtitle="We're looking for passionate individuals who want to make a difference in education technology. Join us in creating innovative solutions that transform how universities manage attendance."
    >
